...
import { formatAnswerValue } from '@/components/game/main-pane/question/estimation/EstimationCommon';
import { Card, CardContent, CardFooter, CardHeader, CardTitle } from '@/components/ui/card';
import { Separator } from '@/components/ui/separator';
import { Tooltip, TooltipContent, TooltipTrigger } from '@/components/ui/tooltip';
import type { Locale } from '@/helpers/locales';
import { LOCALE_TO_EMOJI } from '@/helpers/locales';
import { QUESTION_ELEMENT_TO_EMOJI } from '@/helpers/question';
import { timestampToLongDateTime, type FirestoreTimestamp } from '@/helpers/time';
