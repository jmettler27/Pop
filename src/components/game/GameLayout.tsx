...
import BottomPane from '@/components/game/main-pane/BottomPane';
import MiddlePane from '@/components/game/main-pane/MiddlePane';
import MobilePlayerLayout from '@/components/game/MobilePlayerLayout';
import Sidebar from '@/components/game/sidebar/Sidebar';
import TopPane from '@/components/game/top-pane/TopPane';
import LoadingScreen from '@/components/LoadingScreen';
import { useCurrentTeamScores } from '@/hooks/firestore/score/useCurrentTeamScores';
import { useAllPlayers } from '@/hooks/firestore/user/usePlayerHooks';
