...
import BasicMiddlePane from '@/components/game/main-pane/question/basic/BasicMiddlePane';
import BuzzerMiddlePane from '@/components/game/main-pane/question/buzzer/BuzzerMiddlePane';
import EnumerationMiddlePane from '@/components/game/main-pane/question/enumeration/EnumerationMiddlePane';
import EstimationMiddlePane from '@/components/game/main-pane/question/estimation/EstimationMiddlePane';
import LabellingMiddlePane from '@/components/game/main-pane/question/labelling/LabellingMiddlePane';
import MatchingMiddlePane from '@/components/game/main-pane/question/matching/MatchingMiddlePane';
import MCQMiddlePane from '@/components/game/main-pane/question/mcq/MCQMiddlePane';
import NaguiMiddlePane from '@/components/game/main-pane/question/nagui/NaguiMiddlePane';
import OddOneOutMiddlePane from '@/components/game/main-pane/question/odd-one-out/OddOneOutMiddlePane';
import QuoteMiddlePane from '@/components/game/main-pane/question/quote/QuoteMiddlePane';
import ReorderingMiddlePane from '@/components/game/main-pane/question/reordering/ReorderingMiddlePane';
