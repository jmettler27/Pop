...
export default function GamePage() {
    ...
    const { organizers, loading: orgLoading, error: orgError } = repositories.organizerRepo.useAllOrganizerIdentitiesOnce()
    ...
    const teamId = role === UserRole.PLAYER
        ? players.find(p => p.id === session.user.id)?.teamId
        : null
