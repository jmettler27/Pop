...
import { DEFAULT_LOCALE, Locale, LOCALES, localeSchema, localeToTitle } from '@/frontend/helpers/locales';
...
export default function Page() {
  ...
  return (
    <div className="flex flex-col flex-1 p-8">
      ...
      <FormProvider {...form}>
        <form
          onSubmit={form.handleSubmit(async (values: CreateGameFormValues) => {
            try {
        ...
        >
          <ReactHookFormSelect
            label={intl.formatMessage(messages.selectGameLanguageLabel)}
            name="lang"
          ...
          <ReactHookFormSelect
            label={intl.formatMessage(messages.roundScorePolicyLabel)}
