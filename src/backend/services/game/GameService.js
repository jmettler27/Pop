    ...
    async returnToGameHome() {
        ...
        try {
            await runTransaction(firestore, async (transaction) => {
                ...
                console.log("Round end to game home successfully completed.", "gameID", this.gameId);
            });
        } catch (error) {
    ...
    async resumeEditing() {
        ...
        try {
            await runTransaction(firestore, async (transaction) => {
                ...
                console.log("Editing successfully resumed.", "gameID", this.gameId);
            });
        } catch (error) {
    ...
    async endGame() {
        ...
        try {
            await runTransaction(firestore, async (transaction) => {
                ...
                console.log("Game successfully ended.", "gameID", this.gameId);
            });
        } catch (error) {
