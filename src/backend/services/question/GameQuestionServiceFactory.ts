...
import GameBlindtestQuestionService from '@/backend/services/question/buzzer/GameBlindtestQuestionService';
import GameEmojiQuestionService from '@/backend/services/question/buzzer/GameEmojiQuestionService';
import GameImageQuestionService from '@/backend/services/question/buzzer/GameImageQuestionService';
...
export type AnyGameBuzzerQuestionService =
  | GameBasicQuestionService
  | GameBlindtestQuestionService
  | GameEmojiQuestionService
  | GameImageQuestionService
  | GameProgressiveCluesQuestionService
  | GameQuoteQuestionService;
