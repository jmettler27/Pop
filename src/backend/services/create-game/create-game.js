...
const createGameOrganizersTransaction = async (transaction, gameId, organizerId, organizerName, organizerImage) => {
...
const createGameRealtimeTransaction = async (transaction, gameId, organizerId) => {
