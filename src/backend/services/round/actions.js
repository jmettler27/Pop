...
import { getInitTeamScores } from '@/backend/services/scoring/scores';
import { getDocData } from '@/backend/services/utils';
import { resetSpecialRound } from '@/backend/services/round/special/actions';
...
export async function resetAllRounds(gameId) {
    ...
    try {
        ...
        console.log("All rounds successfully reset.");
    } catch (error) {
...
export async function resetRound(gameId, roundId) {
    ...
    try {
        ...
        console.log(`Round ${roundId} successfully reset.`);
    }
    catch (error) {
