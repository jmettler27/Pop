...
export default class RoundService {
    ...
    async handleQuestionEnd(roundId, questionId) {
        ...
        try {
            await runTransaction(firestore, transaction => this.handleQuestionEndTransaction(transaction, roundId, questionId))
        } catch (error) {
    ...
    async handleRoundSelected(roundId, userId) {
        ...
        try {
            await runTransaction(firestore, async (transaction) =>  await this.handleRoundSelectedTransaction(transaction, roundId, userId))
        } catch (error) {
