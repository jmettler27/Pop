 ...
 * @returns {Yup.StringSchema} The validation schema
 */
export const gameTitleSchema = () => Yup.string()
 ...
 * @returns {Yup.StringSchema} The validation schema
 */
export const participantNameSchema = () => Yup.string()
 ...
 * @returns {Yup.StringSchema} The validation schema
 */
export const teamNameSchema = () => Yup.string()
...
export const roundTypeSchema = () => Yup.string()
    .oneOf(Object.values(RoundType), "Invalid type.")
    .required("Required.")
