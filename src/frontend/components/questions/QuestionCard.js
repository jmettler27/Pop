    ...
    return (
        <Card>
            <CardHeader className='flex flex-row items-center justify-between' >
                <CardTitle className='text-base md:text-lg dark:text-white'><QuestionCardTitle baseQuestion={baseQuestion} showType={showType} /></CardTitle>
            </CardHeader >
...
function QuestionCardFooter({ baseQuestion, lang = DEFAULT_LOCALE }) {
    ...
    return (
        <p className='text-sm md:text-base dark:text-white'>{LOCALE_TO_EMOJI[baseQuestion.lang]} {QUESTION_ELEMENT_TO_TITLE[lang]['createdBy']} <strong>{user.name}</strong> ({timestampToDate(baseQuestion.createdAt, lang)})</p>
    )
}
