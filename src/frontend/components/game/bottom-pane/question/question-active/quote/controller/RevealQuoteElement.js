import { QuoteQuestion, QuoteAuthorElement, QuoteSourceElement, QuotePartElement } from '@/backend/models/questions/Quote'
...
export default function RevealQuoteElementButton({ buzzed, baseQuestion, gameQuestion, lang = DEFAULT_LOCALE }) {
    ...
    return (
        <>
            ...
            <RevealQuoteElementDialog baseQuestion={baseQuestion} quoteElem={element} quoteParts={quoteParts} quotePartIdx={quotePartIdx} dialogOpen={dialogOpen} onDialogClose={onDialogClose} />
        </>
    )
}
...
function RevealQuoteElementDialog({ baseQuestion, quoteElem, quoteParts, quotePartIdx, dialogOpen, onDialogClose, lang = DEFAULT_LOCALE }) {
    ...
    return (
        ...
        >
            <DialogTitle>{REVEAL_LIST_HEADER[lang]}: {QuoteQuestion.elementToTitle(quoteElem)}</DialogTitle>
            <DialogContent>
                <DialogContentText>
