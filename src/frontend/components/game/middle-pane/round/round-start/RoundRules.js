...
function ProgressiveCluesRoundRules({ round }) {
    return <>
        ...
        <p className='2xl:text-2xl text-center'>⏳ Vous avez <u><strong>{ProgressiveCluesQuestion.THINKING_TIME} secondes</strong></u> pour répondre, faute de quoi votre essai sera invalidé !</p>
...
function EmojiRoundRules({ round }) {
    return <>
        ...
        <p className='2xl:text-2xl text-center'>⏳ Vous avez <u><strong>{EmojiQuestion.THINKING_TIME} secondes</strong></u> pour répondre, faute de quoi votre essai sera invalidé !</p>
        <p className='2xl:text-2xl text-center'>⚠️ Vous disposez de <strong>{round.maxTries} essais par question</strong>.</p>
    </>
}
...
function ImageRoundRules({ round }) {
    return <>
        ...
        <p className='2xl:text-2xl text-center'>⏳ Vous avez <u><strong>{ImageQuestion.THINKING_TIME} secondes</strong></u> pour répondre, faute de quoi votre essai sera invalidé !</p>
        <p className='2xl:text-2xl text-center'>⚠️ Vous disposez de <strong>{round.maxTries} essais par question</strong>.</p>
    </>
}
...
function BlindtestRoundRules({ round }) {
    return <>
        ...
        <p className='2xl:text-2xl text-center'>⏳ Vous avez <u><strong>{BlindtestQuestion.THINKING_TIME} secondes</strong></u> pour répondre, faute de quoi votre essai sera invalidé !</p>
        <p className='2xl:text-2xl text-center'>⚠️ Vous disposez de <strong>{round.maxTries} essais par question</strong>.</p>
    </>
}
...
function QuoteRoundRules({ round }) {
    return <>
        <p className='2xl:text-2xl text-center'>💡 Dès que vous avez une idée, <span className='font-bold text-red-500'>buzzez</span> en <strong>cliquant sur &quot;Buzz&quot;</strong>.
            Vous pouvez <span className='font-bold text-blue-400'>annuler votre buzz</span> en <strong>cliquant sur &quot;Annuler&quot;</strong>.</p>
        <p className='2xl:text-2xl text-center'>🥇 Si vous êtes en tête de la file d&apos;attente, proposez votre réponse à l&apos;oral.</p>
        <p className='2xl:text-2xl text-center'>⏳ Vous avez <u><strong>{QuoteQuestion.THINKING_TIME} secondes</strong></u> pour répondre, faute de quoi votre essai sera invalidé !</p>
        <p className='2xl:text-2xl text-center'>⚠️ Vous disposez de <strong>{round.maxTries} essais par question</strong>.</p>
...
function LabellingRoundRules({ round }) {
    return <>
        <p className='2xl:text-2xl text-center'>💡 Dès que vous avez une idée, <span className='font-bold text-red-500'>buzzez</span> en <strong>cliquant sur &quot;Buzz&quot;</strong>.
            Vous pouvez <span className='font-bold text-blue-400'>annuler votre buzz</span> en <strong>cliquant sur &quot;Annuler&quot;</strong>.</p>
        <p className='2xl:text-2xl text-center'>🥇 Si vous êtes en tête de la file d&apos;attente, proposez votre réponse à l&apos;oral.</p>
        <p className='2xl:text-2xl text-center'>⏳ Vous avez <u><strong>{LabellingQuestion.THINKING_TIME} secondes</strong></u> pour répondre, faute de quoi votre essai sera invalidé !</p>
        <p className='2xl:text-2xl text-center'>⚠️ Vous disposez de <strong>{round.maxTries} essais par question</strong>.</p>
        <p className='2xl:text-2xl text-center'>😈 Vous pouvez gagner des points <strong>même si vous ne connaissez pas tous les éléments !</strong></p>
    </>
}
...
function OddOneOutRoundRules({ round }) {
    ...
    return <>
        ...
        <p className='2xl:text-2xl text-center'>⏳ Vous avez <u><strong>{OddOneOutQuestion.THINKING_TIME} secondes</strong></u> pour vous décider, faute de quoi <strong>une proposition sera choisie aléatoirement dans la liste !</strong></p>
...
function MatchingRoundRules({ round }) {
    ...
    return <>
        ...
        <p className='2xl:text-2xl text-center'>🙅 L&apos;équipe est <strong>disqualifiée</strong> de la question au bout de <strong>{maxMistakes || MatchingQuestion.MAX_NUM_MISTAKES} erreurs</strong>, et la question s&apos;arrête si toutes les équipes sont disqualifiées.</p>
        <p className='2xl:text-2xl text-center'>⏳ Vous avez <u><strong>entre {MatchingQuestion.THINKING_TIME * (MatchingQuestion.MIN_NUM_COLS - 1)} et {MatchingQuestion.THINKING_TIME * (MatchingQuestion.MAX_NUM_COLS - 1)} secondes</strong></u> pour vous décider, faute de quoi <strong>un lien aléatoire sera dessiné !</strong></p>
        <p className='2xl:text-2xl text-center'>L&apos;ordre de passage = {order > 0 ? `Le classement inversé de la manche ${order}` : 'Un ordre aléatoire'}.</p>
    </>
}
...
function NaguiRoundRules({ round }) {
    return <>
        <p className='2xl:text-2xl text-center'>❓ Chaque question est attribuée à une équipe. L&apos;équipe a alors <strong>{NaguiQuestion.OPTIONS.length} options</strong> à sa disposition:</p>
        <ol className='2xl:text-2xl border-solid border-blue-500 border-2 p-2'>
            {NaguiQuestion.OPTIONS.map((option, index) => <li key={index}>{NaguiQuestion.typeToEmoji(option)} {NaguiQuestion.typeToTitle(option, 'fr-FR')} ({round.rewardsPerQuestion[option]} pt{round.rewardsPerQuestion[option] > 1 && 's'})</li>)}
        </ol>
        <p className='2xl:text-2xl text-center'>L&apos;ordre de passage = {round.order > 0 ? `Le classement inversé de la manche ${round.order}` : 'Un ordre aléatoire'}.</p>
    </>
}
...
function BasicRoundRules({ round }) {
    return <>
        ...
        <p className='2xl:text-2xl text-center'>⏳ Vous avez <u><strong>{BasicQuestion.THINKING_TIME} secondes</strong></u> pour répondre, faute de quoi votre essai sera invalidé !</p>
        <p className='2xl:text-2xl text-center'>L&apos;ordre de passage = {round.order > 0 ? `Le classement inversé de la manche ${round.order}` : 'Un ordre aléatoire'}.</p>
    </>
}
