        ...
        default: return (
            <div className='flex flex-col items-center justify-start space-y-4 p-2'>
                ...
                <div className='flex flex-col items-center justify-start'>
                    ...
                    <br></br>
                    <p className='2xl:text-2xl text-center'>où les équipes sont classées dans l&apos;ordre <strong>{(round.type === RoundType.ODD_ONE_OUT || round.type === RoundType.MATCHING) ? "⚠️ croissant" : "décroissant"}</strong> du nombre de points gagnés.</p>
                </div>
            </div>
        )
    }
