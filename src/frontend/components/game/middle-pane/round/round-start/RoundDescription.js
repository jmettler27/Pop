...
function BlindtestRoundDescription({ }) {
    return <>
        <p className='2xl:text-2xl text-center'>👂 Écoutez la musique ({BlindtestQuestion.typeToEmoji(BlindtestQuestion.TYPE_SONG)}) ou le son ({BlindtestQuestion.typeToEmoji(BlindtestQuestion.TYPE_SOUND)}), et répondez à la question.</p>
        <br></br>
...
function MatchingRoundDescription({ }) {
    return <>
        <p className='2xl:text-2xl text-center'>🔀 Une grille, organisée en <strong>{MatchingQuestion.MIN_NUM_COLS} à {MatchingQuestion.MAX_NUM_COLS}</strong> colonnes de propositions affichées dans un ordre aléatoire, et entre lesquelles il existe des liens.</p>
...
function OddOneOutRoundDescription({ }) {
    return <>
        <p className='2xl:text-2xl text-center'>🔀 Une liste de <strong>{OddOneOutQuestion.MAX_NUM_ITEMS} propositions</strong>, affichée dans un <strong>ordre aléatoire</strong> pour chaque participant.</p>
        <br />
...
function QuoteRoundDescription({ }) {
    return <>
        ...
        <ul className='2xl:text-2xl list-disc pl-10'>
            <li>{QuotePartElement.elementToEmoji()} Une <strong>réplique</strong></li>
            <li>{QuoteAuthorElement.elementToEmoji()} La <strong>personne</strong> qui l&apos;a prononcée</li>
            <li>{QuoteSourceElement.elementToEmoji()} L&apos;<strong>œuvre</strong> dont elle est issue</li>
        </ul>
        <br />
