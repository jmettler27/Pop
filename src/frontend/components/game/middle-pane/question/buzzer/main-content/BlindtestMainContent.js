    ...
    <Box className="w-full overflow-hidden">
      <Widget>
        ...
        <Box className="flex flex-row items-center justify-center" sx={{ mt: -1 }}>
          {/* Fast Rewind */}
          <IconButton aria-label="fast rewind" onClick={() => (audioRef.current.currentTime -= 10)}>
          ...
          {/* Fast Forward */}
          <IconButton aria-label="fast forward" onClick={() => (audioRef.current.currentTime += 10)}>
...
function EndedBlindtestMainContent({ baseQuestion }) {
