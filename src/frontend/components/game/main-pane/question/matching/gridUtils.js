...
export const getNodeId = (origRow, col) => `${origRow}_${col}`;

export const getNodeOrigCoords = (id) => id.split('_').map(Number);
...
export const getNodePosition = (id, nodePositions) => getNode(id, nodePositions).pos;
