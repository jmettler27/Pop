...
import EnumerationPlayers from '@/frontend/components/game/main-pane/question/enumeration/EnumerationPlayers';
import { EnumerationQuestion } from '@/models/questions/enumeration';

export default function EnumerationBottomPane({ baseQuestion }: { baseQuestion: EnumerationQuestion }) {
  return (
