...
const TopPaneContainer = memo(function TopPaneContainer({  }) {
    ...
    if (teamsError) return <p><strong>Error loading teams</strong></p>
    if (scoresError) return <p><strong>Error loading scores</strong></p>
    if (playersError) return <p><strong>Error loading players</strong></p>
