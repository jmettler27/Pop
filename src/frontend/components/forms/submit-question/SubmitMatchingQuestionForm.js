...
import { MyTextInput, MySelect, StyledErrorMessage, MyNumberInput } from '@/frontend/components/forms/StyledFormComponents'
        ...
        >
            ...
            <GeneralInfoStep
                ...
                validationSchema={Yup.object({
                    ...
                    numCols: Yup.number()
                        .min(MatchingQuestion.MIN_NUM_COLS, `Must be between ${MatchingQuestion.MIN_NUM_COLS} and ${MatchingQuestion.MAX_NUM_COLS}`)
                        .max(MatchingQuestion.MAX_NUM_COLS, `Must be between ${MatchingQuestion.MIN_NUM_COLS} and ${MatchingQuestion.MAX_NUM_COLS}`)
                        .required("Required."),
                })}
                lang={lang}
            />
    ...
    return (
        ...
        >
            ...
            <MyNumberInput
                ...
                name='numCols'
                min={MatchingQuestion.MIN_NUM_COLS} max={MatchingQuestion.MAX_NUM_COLS}
            // validationSchema={validationSchema}
            />
...
function EnterMatchesStep({ onSubmit, lang }) {
    ...
    return (
        <WizardStep
            ...
            validationSchema={validationSchema}
        >
            <p>{NUM_MATCHES_ALLOWED[lang]}: {MatchingQuestion.MIN_NUM_ROWS}-{MatchingQuestion.MAX_NUM_ROWS}. </p>
