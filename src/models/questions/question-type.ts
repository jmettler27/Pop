...
export function isValidQuestionType(type: QuestionType): type is QuestionType {
  return (Object.values(QuestionType) as string[]).includes(type);
}

export const QuestionTypeToEmoji: Record<QuestionType, string> = {
  [QuestionType.BASIC]: '❓',
...
export const QuestionTypeToTitle: Record<Locale, Record<QuestionType, string>> = {
  en: {
...
export function questionTypeToEmoji(type: QuestionType): string {
  return QuestionTypeToEmoji[type];
}

export function questionTypeToTitle(type: QuestionType, locale: Locale = DEFAULT_LOCALE): string {
  return QuestionTypeToTitle[locale]?.[type] || type;
}

export function prependQuestionTypeWithEmoji(type: QuestionType, locale: Locale = DEFAULT_LOCALE): string {
...
export const QuestionTypeToDescription: Record<Locale, Record<QuestionType, string>> = {
  en: {
...
export function questionTypeToDescription(type: QuestionType, locale: Locale = DEFAULT_LOCALE): string {
